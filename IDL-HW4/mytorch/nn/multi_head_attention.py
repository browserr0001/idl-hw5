...
class MultiHeadAttention:
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        ...
        if key_padding_mask is None and attn_mask is None:
            return None
        merged_mask = np.zeros((self.N, self.num_heads, self.L, self.S), dtype=bool)
        ...
        if key_padding_mask is not None:
            ...
            merged_mask = np.logical_or(merged_mask, key_mask)
        ...
        if attn_mask is not None:
            ...
            merged_mask = np.logical_or(merged_mask, attention_mask)
